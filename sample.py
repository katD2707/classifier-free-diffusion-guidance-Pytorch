...
def sample(params: argparse.Namespace):
    ...
    checkpoint = torch.load(
        os.path.join(params.moddir, f"ckpt_{params.epoch}_checkpoint.pt"),
        map_location="cpu",
    )
    ...
    if params.label == "range":
        lab = torch.ones(params.clsnum, each_device_batch // params.clsnum).type(
            torch.long
...
def main():
    ...
    parser.add_argument(
        "--genbatch", type=int, default=5600, help="batch size for sampling process"
    )
    ...
    parser.add_argument(
        "--epoch", type=int, default=1000, help="epochs for loading models"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--label", type=str, default="range", help="labels of generated images"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--droprate", type=float, default=0, help="dropout rate for model"
    )
    ...
    parser.add_argument(
        ...
        default=False,
        help="generate samples used for quantative evaluation",
    )
    parser.add_argument(
        "--genum", type=int, default=5600, help="num of generated samples"
    )
    parser.add_argument(
